...
public class BusinessLogicService {
   ...
   public void listPersonRoles() {
      //Session session = pR.sessionFactory.openSession();
      ...
      for (Iterator iterator = personRoles.iterator(); iterator.hasNext();) {
            ...
            Role role = r.getRole(pr.getRoleId());
            Person person = p.getPerson(pr.getPersonId());
            System.out.println(String.format("%-30s%-30s%-30s%-35s" , pr.getRoleId(), role.getRoleName(), person.getName() ,pr.getPersonId()));
      }
      System.out.println("-------------------------------------------------------------------------------------------------------------"
      + "---------------------------------------" );
   ...
   public void listContactInfo() {
      Session session = c.sessionFactory.openSession();
      List<ContactInfo> cinfos = c.listContactInfo(session);
      ...
      for (Iterator iterator = cinfos.iterator(); iterator.hasNext();) {
            ...
            , ci.getInformation() , ci.getPerson().getName(), ci.getPerson().getId() ));
   ...
   public ContactInfo initializeAndUnproxy(ContactInfo entity) {
    if (entity == null) {
        throw new 
    ...
    if (entity instanceof HibernateProxy) {
        entity = (ContactInfo) ((HibernateProxy) entity).getHibernateLazyInitializer()
                .getImplementation();
    }
    return entity;
}
