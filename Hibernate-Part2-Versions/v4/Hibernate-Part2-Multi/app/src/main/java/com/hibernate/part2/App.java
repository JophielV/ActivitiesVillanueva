package com.hibernate.part2;


import com.hibernate.part2.model.Address;
import com.hibernate.part2.model.ContactInfo;
import com.hibernate.part2.model.Name;
import com.hibernate.part2.model.Person;
import com.hibernate.part2.model.Role;
import com.hibernate.part2.service.ValidationService;
import com.hibernate.part2.service.BusinessLogicService;
...
public class App 
{
    ...
    {      
        ...
        System.out.println("--------------------- Welcome to Hibernate-Part2 Program!------------------");
    ...
    public static void updatePersonModule() {
       businessLogicService.listPersons(1);
       sc.nextLine();
       String id = "";
       boolean holder = true;
       boolean holder2 = true;
    ...
    public static void switchCaseUpdateField(int subChoice, String id) {
       ...
       switch(subChoice) {
          ...
          case 11:
             ...
             break;
          case 12:
             updateContactUnderUpdateModule(id);
             break;

          case 13: 
             deleteContactUnderUpdateModule(id);
             break;
          ...
          case 15:
             deleteRoleUnderUpdateModule(id);
             break;
    ...
    public static void updateContactModule() {
       String id = "", landLine ="", mobileNo = "", email = "";
       boolean holder = true;
       boolean holder2 = true;
       int choice = 0;
       ...
       ContactInfo ci = businessLogicService.getContactInfoEntity(id);
       if(ci.getType().equals("LandLine")) { choice = 1; }
       else if(ci.getType().equals("Mobile No")) { choice = 2; }
       else if(ci.getType().equals("Email")) { choice = 3; } 

       updateContactMode(id,choice);
    }

    public static void updateContactUnderUpdateModule(String id) {
       businessLogicService.listContactInfo(id);

       String id2="", landLine ="", mobileNo = "", email = "";
       boolean holder = true;
       boolean holder2 = true;
       int choice = 0;
       ...
       while(holder || !holder2) { 
           ...
           holder = validationService.validateId(id2);
           if(holder)  { continue; }
           holder2 = businessLogicService.checkIfEntityContactInfoExist(id,id2);
       }
       
       ContactInfo ci = businessLogicService.getContactInfoEntity(id,id2);
       if(ci.getType().equals("LandLine")) { choice = 1; }
       else if(ci.getType().equals("Mobile No")) { choice = 2; }
       else if(ci.getType().equals("Email")) { choice = 3; } 

       updateContactMode(id2,choice);
    }

    public static void updateContactMode(String id, int choice) {
       String landLine ="", mobileNo = "", email = "";
       boolean holder = true;
       switch(choice) {
          case 1:
             ...
             businessLogicService.updateContactInfoEntity(id,landLine);
             System.out.println("- Notice: Update Contact Success -");
             pauseProgram();
             break;       
          case 2:
             ...
             while(holder) {
                ...
                holder = validationService.validateMobileNumber(mobileNo);
             }
             businessLogicService.updateContactInfoEntity(id,mobileNo);
             System.out.println("- Notice: Update Contact Success -");
             pauseProgram();
             break;
          case 3:
             ...
             businessLogicService.updateContactInfoEntity(id,email);
             System.out.println("- Notice: Update Contact Success -");
             pauseProgram();
             break;
          default: System.out.println("- Notice:  Taking you back to the menu .. -");
       }
    }

    public static void addContactMode(String id) {
       boolean holder = true;
       boolean holder2 = true;
       int choice = 0;
           ...
           switch(choice) {
              case 1:
                 ...
                 while(holder2) {
                    System.out.print("Land Line No: ");
                    landLine = sc.nextLine(); 
                    holder2 = validationService.validateLandLine(landLine);
                 }
                 ci = businessLogicService.createContactInfoEntity("LandLine", landLine);
                 if(ci != null) { businessLogicService.addContactToPerson(id,ci); }
              ...
              case 2:
                 ...
                 while(holder2) {
                    System.out.print("Mobile No: ");
                    mobileNo = sc.nextLine(); 
                    holder2 = validationService.validateMobileNumber(mobileNo);
                 }
                 ci = businessLogicService.createContactInfoEntity("Mobile No", mobileNo);
                 if(ci != null) { businessLogicService.addContactToPerson(id,ci); }
                 System.out.println("-------- Notice: Add Contact Success ------");
                 pauseProgram();
                 break;
              case 3:
                 while(holder2) {
                    System.out.print("Email: ");
                    email = sc.nextLine(); 
                    holder2 = validationService.validateEmail(email);
                 }
                 ci = businessLogicService.createContactInfoEntity("Email", email);
                 if(ci != null) { businessLogicService.addContactToPerson(id,ci); }
                 System.out.println("-------- Notice: Add Contact Success ------");
                 pauseProgram();
                 break;
    ...
    public static void deleteContactUnderUpdateModule(String id) {
       businessLogicService.listContactInfo(id);
       ...
       holder2 = businessLogicService.deleteContactInfoEntity(id2);  
       pauseProgram();
    }
    ...
    public static void deleteRoleUnderUpdateModule(String id) {
       String id2 = "";
       boolean holder = true;
       boolean holder2 = true;
       businessLogicService.getRoleOfPerson(id);          
       System.out.println("------------------------- Delete Role ------------------------");
       sc.nextLine();
       while(holder || !holder2) { 
          System.out.print("Enter the id of the role to delete for the person: ");
    ...
    public static void displayUpdateChoice() {
       ...
       System.out.println("(12) Update Contact");
       System.out.println("(13) Delete Contact");
       System.out.println("(14) Add Role "); 
       System.out.println("(15) Delete Role");
       System.out.println("(16) Back to Main Menu");
    } 

    public static void displayAddContactChoice() {
       System.out.println("--------------------- Add Contact----------------------");
