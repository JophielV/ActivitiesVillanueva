      ...
      <form:form method="post" modelAttribute="person" action="/app/Person/save" cssClass="form-horizontal">
        ...
        <div class="form-group ">
           <form:label path="name.firstName" cssClass="col-xs-2 control-label">First Name:</form:label>
              <div class="col-xs-3">
                 <form:input path="name.firstName" cssClass="form-control" placeholder="First Name" pattern="^[A-Za-z ,.'-]+$" required="required"></form:input>
              </div>
        </div>
        <div class="form-group ">
           <form:label path="name.lastName" cssClass="col-xs-2 control-label">Last Name:</form:label>
              <div class="col-xs-3">
                 <form:input path="name.lastName" cssClass="form-control" placeholder="Last Name" pattern="^[A-Za-z ,.'-]+$" required="required"></form:input>
              </div>
        </div>
        <div class="form-group ">
           <form:label path="name.middleName" cssClass="col-xs-2 control-label">Middle Name:</form:label>
              <div class="col-xs-3">
                 <form:input path="name.middleName" cssClass="form-control" placeholder="Middle Name" pattern="^[A-Za-z ,.'-]+$" required="required"></form:input>
              </div>
        </div>
        <div class="form-group ">
           <form:label path="name.suffix" cssClass="col-xs-2 control-label">Suffix:</form:label>
              <div class="col-xs-3">
                 <form:input path="name.suffix" cssClass="form-control" placeholder="Suffix" pattern="^[A-Za-z ,.'-]+$" required="required"></form:input>
              </div>
        </div>
        <div class="form-group ">
           <form:label path="name.title" cssClass="col-xs-2 control-label">Title:</form:label>
              <div class="col-xs-3">
                 <form:input path="name.title" cssClass="form-control" placeholder="Title" pattern="^[A-Za-z ,.'-]+$" required="required"></form:input>
              </div>
        </div>
        <h3>Address: </h3>
        <div class="form-group ">
           <form:label path="address.streetNo" cssClass="col-xs-2 control-label">Street No.:</form:label>
              <div class="col-xs-3">
                 <form:input path="address.streetNo" cssClass="form-control" placeholder="Street No." pattern="^[0-9]+$" required="required"></form:input>
              </div>
        </div>
        <div class="form-group ">
           <form:label path="address.barangay" cssClass="col-xs-2 control-label">Barangay:</form:label>
              <div class="col-xs-3">
                 <form:input path="address.barangay" cssClass="form-control" placeholder="Barangay" pattern="^[A-Za-z ,.'-]+$" required="required"></form:input>
              </div>
        </div>
        <div class="form-group ">
           <form:label path="address.city" cssClass="col-xs-2 control-label">City:</form:label>
              <div class="col-xs-3">
                 <form:input path="address.city" cssClass="form-control" placeholder="City" pattern="^[A-Za-z ,.'-]+$" required="required"></form:input>
              </div>
        </div>
        <div class="form-group ">
           <form:label path="address.zipCode" cssClass="col-xs-2 control-label">Zip Code:</form:label>
              <div class="col-xs-3">
                 <form:input path="address.zipCode" cssClass="form-control" placeholder="Zip Code" pattern="^[0-9]+$" required="required"></form:input>
              </div>
        </div>
        ...
        <div class="form-group ">
           <label class="col-xs-2 control-label">Currently Employed: </label>
              <div class="col-xs-3">
                 <input type="text" name="employed" class="form-control" placeholder="Y or N" pattern="^Y|N$" required> 
              </div>
        </div>
        <div class="form-group">
