...
public class ContactInfoController {
    ...
    public String save(@ModelAttribute("contact") ContactInfo contact, @RequestParam("personId") int personId) {
         ContactInfo ci = new ContactInfo();
         
         service.addContactToPerson(personId,contact); 
		
	 return "redirect:/ContactInfo/";	
    }

    @RequestMapping(value = "/saveUpdate", method = RequestMethod.POST)
    public String saveUpdate(@RequestParam("contactId") int personId, @RequestParam("information") String information) {         
         service.updateContactInfoEntity(personId,information); 
