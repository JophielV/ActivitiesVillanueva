...
<body>
   <div class="wholecontainer">
    ...
    <div class="alert alert-warning">
      ...
      <form:form method="post" modelAttribute="contact" action="/app/ContactInfo/save" cssClass="form-horizontal">
        ...
        <div class="form-group ">
           ...
           <div class="col-xs-3">
              <form:input path="type" cssClass="form-control" placeholder="Email,Mobile Number or Land Line" required="required"></form:input>
           </div>                        
        </div>
        <div class="form-group ">
            <form:label path="information" cssClass="col-xs-2 control-label">Information:</form:label>
            <div class="col-xs-3">
                <form:input path="information" cssClass="form-control" placeholder="Information" required="required"></form:input>      
            </div>
        </div>
        <div class="form-group">
