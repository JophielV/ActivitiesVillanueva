	...
	<form:hidden path="id" value="${person.getId()}"/>
        ...
        <div class="form-group ">
           <form:label path="birthday" cssClass="col-xs-2 control-label">Birthday:</form:label>
              <div class="col-xs-3">
                 <form:input path="birthday" cssClass="form-control" value="10/25/2016" required="required" id="datepicker"></form:input>
              </div>
        </div>
        <div class="form-group ">
        ...
        <div class="form-group ">
           <form:label path="dateHired" cssClass="col-xs-2 control-label">Date Hired:</form:label>
              <div class="col-xs-3">
                 <form:input path="dateHired" cssClass="form-control" value="10/25/2016" required="required" id="datepicker2"></form:input>
              </div>
        </div>
        <div class="form-group ">
           <form:label path="currentlyEmployed" cssClass="col-xs-2 control-label">Currently Employed?:</form:label>
              <div class="col-xs-3">
                 <form:input path="currentlyEmployed" cssClass="form-control" value="${person.getCurrentlyEmployed()}" required="required"></form:input>
              </div>
        </div>
        <div class="form-group">
