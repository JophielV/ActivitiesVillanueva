...
public class ValidationService {
   ...
   public boolean validateName(String n) {
      if(n.matches("^.*[^a-zA-Z].*$")) { 
          System.out.println("- Notice: Name contains non alphabetic character(s). Enter a valid name -");
          return true; 
      }
   ...
   public boolean validateSuffix(String n) {
      if(n.matches("[a-zA-Z]+\\.?[a-zA-Z]*")) { return false; }
      if(n.matches("^.*[^a-zA-Z].*$")) { 
   ...
   public boolean validateBarangay(String n) {
      if(n.matches("^.*[^a-zA-Z].*$")) { 
          System.out.println("- Notice: Barangay contains non alphabetic character(s). Enter a valid barangay. -");
          return true; 
      }
      if(n.trim().isEmpty() || n.isEmpty() || n == null) {
          System.out.println("- Notice: Please enter a valid value. Enter N/A if not applicable -");
    ...
    public boolean validateCity(String n) {
      if(n.matches("^.*[^a-zA-Z].*$")) { 
          System.out.println("- Notice: City contains non alphabetic character(s). Enter a valid city. -");
          return true; 
      }
      if(n.trim().isEmpty() || n.isEmpty() || n == null) {
          System.out.println("- Notice: Please enter a valid value. Enter N/A if not applicable -");
