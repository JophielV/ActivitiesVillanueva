...
public class PersonServlet extends HttpServlet {
     ...
     private static String VIEW_ALL_GWA = "/persons2.jsp";
     private static String VIEW_ALL_DATE_HIRED = "/persons3.jsp";
     private static String VIEW_ALL_LASTNAME = "/persons4.jsp";
     ...
     public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equals("view")) {
           ...
           forward = VIEW_ALL_GWA;
           request.setAttribute("service",service);
        }
        else if(action.equals("viewAll3")) {
           forward = VIEW_ALL_DATE_HIRED;
           request.setAttribute("service",service);
        }
        else if(action.equals("viewAll4")) {
           forward = VIEW_ALL_LASTNAME;
           request.setAttribute("service",service);
        }
