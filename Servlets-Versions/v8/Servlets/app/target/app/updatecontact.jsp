...
<body>
   <div class="wholecontainer">
      <%
        ...
        ContactInfo contact = (ContactInfo) request.getAttribute("contact"); 
    ...
    <div class="alert alert-warning">
      ...
      <form class="form-horizontal" method="post" action="ContactInfo">
        ...
        <div class="form-group ">
            ...
            <div class="col-xs-3">
                <input type="text" name="type" id="contactType" class="form-control" value="<%=contact.getType()%>" required readonly>            
            </div>
        </div>
        <div class="form-group ">
            <label class="col-xs-2 control-label" >Information: </label>
            <div class="col-xs-3">
                <input type="text" name="information" id="info" class="form-control" value="<%=contact.getInformation()%>" required >            
            </div>
            <span class="validate"></span>
        </div>
        <div class="form-group">
            <div class="col-xs-offset-2 col-xs-10">
                <button type="submit" value="Submit" class="btn btn-primary" id="submitButton"><span class="glyphicon glyphicon-pencil"></span>Update</button>
            </div>
        </div>
    </form>
   </div>
