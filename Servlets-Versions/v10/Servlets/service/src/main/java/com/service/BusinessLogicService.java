...
public class BusinessLogicService {  
   private static BusinessLogicService uniqueInstance;
   ...
   private BusinessLogicService(String username, String password) {
   ...
   public static BusinessLogicService getInstance(String u, String p) {
      if(uniqueInstance == null) {
         uniqueInstance = new BusinessLogicService(u,p);
      }
   ...
   public List listPersons(int choice) {
      ...
      return persons;//this.people = persons;
   }  

   public void listPersons2(int choice) {
      List<Person> persons = new ArrayList<Person>();
      persons = p.listPersons(choice);
